        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Welcome to our coffee shop! We serve the finest quality coffee beans 
              from around the world. Enjoy fresh roasted coffee, delicious pastries, 
              and a cozy atmosphere perfect for work or relaxation.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="flex">
              ...
              />
              <button className="bg-amber-600 hover:bg-amber-700 text-white px-6 py-2 rounded-r-lg transition-colors duration-200 font-medium">
                Subscribe
              </button>
            </div>
          </div>
